...
_QUOTING_ALLOWED_RULES = (
    ...
    "worth landing on. 'It saves me summarising it' is not one of them.\n"
    "- KEEP EACH ONE TO A PHRASE. About five words is typical and ten is the outside limit — a "
    "fragment carrying a term or a formulation, set inside a sentence of your own. Never a whole "
    "sentence lifted across, and never a block quotation: a passage long enough to stand alone is "
    "a passage you have declined to summarise. Roughly one quotation per two or three hundred "
    "words of section is the natural rate, so a short section may well have none; a section thick "
    "with quotation is one where the writer's own argument has gone missing.\n"
